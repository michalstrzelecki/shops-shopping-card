    ...
    <div class="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5">
        <template x-for="product in products">
            <div class="flex flex-col rounded overflow-hidden shadow-lg">
                ...
                <div class="px-6 py-4 mt-auto flex justify-end">
                    <button class="bg-white border-2 border-gray-500 hover:border-gray-900 rounded-full px-3 py-2 text-sm font-semibold text-gray-500 hover:text-gray-900">
                        Add to basket
                    </button>
                </div>
            </div>
